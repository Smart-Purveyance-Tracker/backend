...
func (o *SignupBody) validateEmail(formats strfmt.Registry) error {

	if err := validate.Required("user info"+"."+"email", "body", o.Email); err != nil {
		return err
	}
...
func (o *SignupBody) validatePassword(formats strfmt.Registry) error {
	...
	if err := validate.Required("user info"+"."+"password", "body", o.Password); err != nil {
		return err
	}
